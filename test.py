        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    print("the terrain appears to be " + strClassification + ", " + "{0:.2f}".format(scoreAsAPercent) + "% confidence")
                    #print(strClassification+".")
                    #os.remove("D:/Maverick_141/Callidus - V/TextureRecognizer/TF_OutfitRecognizer/test_images/testimg.jpg")
